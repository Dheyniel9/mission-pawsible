 ...
 */
export const Reuinited_pets = ({ className }: Reuinited_petsProps) => {
    return (
                ...
                <div className={styles['middle-content']}>
                    <div className={styles['img-container']}>
                        ...
                        <div className={styles['middle-text']}>
                            <h4 className={styles['petdetail-text']}>MO502- Poodle Tiny Yellow</h4>
                        </div>
